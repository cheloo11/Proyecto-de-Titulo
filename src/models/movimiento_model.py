...
class MovimientoModel:
    ...
    def get_all():
        ...
        try:
            return db.fetch_all("""
                ...
                LEFT JOIN contratistas c ON m.id_contratista = c.id
    ...
    @staticmethod
    def insert_entrada(movimiento):
        """
        Inserta un registro de entrada de material en la base de datos.
        
        Args:
            movimiento: Diccionario con los datos del movimiento
                - id_material: ID del material
                - id_usuario: ID del usuario que registra el movimiento
                - tipo_movimiento: Tipo de movimiento ('entrada')
                - cantidad: Cantidad de material
                - fecha: Fecha del movimiento
                - observaciones: Observaciones del movimiento (opcional)
